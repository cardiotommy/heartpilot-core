...
test('Last remaining vessel + severe EF fires strongest MCS rule', () => {
  ...
  // haem-mcs-last-vessel must NOT fire (it requires lvef_severe=false for mutual exclusion)
  assertNotMatched(result, 'haem-mcs-last-vessel');
  assertNotMatched(result, 'haem-mcs-consider'); // disabled (active: false)
});
